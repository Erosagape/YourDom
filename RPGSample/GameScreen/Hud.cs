    ...
    public class Hud
    {
        ...
        public void LoadContent()
        {
            ...
            backgroundHudTexture =
                content.Load<Texture2D>(@"Texture\HUD\HudBkgd");
            topHudTexture =
                content.Load<Texture2D>(@"Texture\HUD\CombatStateInfoStrip");
            activeCharInfoTexture =
                content.Load<Texture2D>(@"Texture\HUD\PlankActive");
            inActiveCharInfoTexture =
                content.Load<Texture2D>(@"Texture\HUD\PlankInActive");
            cantUseCharInfoTexture =
                content.Load<Texture2D>(@"Texture\HUD\PlankCantUse");
            selectionBracketTexture =
                content.Load<Texture2D>(@"Texture\HUD\SelectionBrackets");
            deadPortraitTexture =
                content.Load<Texture2D>(@"Texture\Characters\Portraits\Tombstone");
            combatPopupTexture =
                content.Load<Texture2D>(@"Texture\HUD\CombatPopup");
            charSelFadeLeftTexture =
                content.Load<Texture2D>(@"Texture\Buttons\CharSelectFadeLeft");
            charSelFadeRightTexture =
                content.Load<Texture2D>(@"Texture\Buttons\CharSelectFadeRight");
            charSelArrowLeftTexture =
                content.Load<Texture2D>(@"Texture\Buttons\CharSelectHlLeft");
            charSelArrowRightTexture =
                content.Load<Texture2D>(@"Texture\Buttons\CharSelectHlRight");
            actionTexture =
                content.Load<Texture2D>(@"Texture\HUD\HudSelectButton");
            yButtonTexture =
                content.Load<Texture2D>(@"Texture\Buttons\YButton");
            startButtonTexture =
                content.Load<Texture2D>(@"Texture\Buttons\StartButton");
            menuTexture =
                content.Load<Texture2D>(@"Texture\HUD\Menu");
            statsTexture =
                content.Load<Texture2D>(@"Texture\HUD\Stats");
        }
        /// <summary>
        /// Draw the screen.
        /// </summary>
