...
namespace RPGSample
{
    class ControlsScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            backgroundTexture =
content.Load<Texture2D>(@"Texture\MainMenu\MainMenu");
    ...
    (viewport.Height - backgroundTexture.Height) / 2);
            ...
            keyboardTexture =
                content.Load<Texture2D>(@"Texture\MainMenu\KeyboardBkgd");
            plankTexture =
            ...
            controlPadTexture =
                content.Load<Texture2D>(@"Texture\MainMenu\ControlJoystick");
            scrollUpTexture =
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Draw(backTexture, backgroundPosition+backPosition, Color.White);
            spriteBatch.DrawString(Fonts.ButtonNamesFont, "Back",
                backgroundPosition+new Vector2(backPosition.X + 55, backPosition.Y + 5), Color.White);
            ...
            spriteBatch.Draw(baseBorderTexture, backgroundPosition+baseBorderPosition, Color.White);

            // draw the control pad screen
            if (isShowControlPad)
            {                
                spriteBatch.Draw(controlPadTexture, controlPosition,Color.White);
