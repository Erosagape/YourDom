...
namespace RPGSample
{
    ...
    class DialogueScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            scrollTexture =
                content.Load<Texture2D>(@"Texture\GameScreens\ScrollButtons");
            selectButtonTexture = content.Load<Texture2D>(@"Texture\Buttons\AButton");
            backButtonTexture = content.Load<Texture2D>(@"Texture\Buttons\BButton");
            lineTexture =
