...
namespace RPGSample
{
    public class PlayerSelectionScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            // Display screens
            playerInfoScreen =
                content.Load<Texture2D>(@"Texture\GameScreens\PopupScreen");
            ...
            scoreBoard =
                content.Load<Texture2D>(@"Texture\GameScreens\CountShieldWithArrow");
            lineTexture =
                content.Load<Texture2D>(@"Texture\GameScreens\SeparationLine");
            selectButton = content.Load<Texture2D>(@"Texture\Buttons\AButton");
            backButton = content.Load<Texture2D>(@"Texture\Buttons\BButton");
            tickMarkTexture = content.Load<Texture2D>(@"Texture\GameScreens\TickMark");
            playerSelTexture =
                content.Load<Texture2D>(@"Texture\GameScreens\PlayerSelected");
            playerUnSelTexture =
                content.Load<Texture2D>(@"Texture\GameScreens\PlayerUnSelected");
