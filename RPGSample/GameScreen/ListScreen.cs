...
namespace RPGSample
{
    abstract class ListScreen<T> : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            fadeTexture = content.Load<Texture2D>(@"Texture\GameScreens\FadeScreen");
            backgroundTexture =
                content.Load<Texture2D>(@"Texture\GameScreens\GameScreenBkgd");
            listTexture =
                content.Load<Texture2D>(@"Texture\GameScreens\InfoDisplay");
            plankTexture =
                content.Load<Texture2D>(@"Texture\MainMenu\MainMenuPlank03");
            goldTexture =
                content.Load<Texture2D>(@"Texture\GameScreens\GoldIcon");

            // load the foreground textures
            highlightTexture =
                content.Load<Texture2D>(@"Texture\GameScreens\HighlightLarge");
            selectionArrowTexture =
                content.Load<Texture2D>(@"Texture\GameScreens\SelectionArrow");

            // load the trigger images
            leftTriggerTexture =
                content.Load<Texture2D>(@"Texture\Buttons\LeftTriggerButton");
            rightTriggerTexture =
                content.Load<Texture2D>(@"Texture\Buttons\RightTriggerButton");
            leftQuantityArrowTexture =
                content.Load<Texture2D>(@"Texture\Buttons\QuantityArrowLeft");
            rightQuantityArrowTexture =
                content.Load<Texture2D>(@"Texture\Buttons\QuantityArrowRight");
            backButtonTexture =
                content.Load<Texture2D>(@"Texture\Buttons\BButton");
            selectButtonTexture =
                content.Load<Texture2D>(@"Texture\Buttons\AButton");
            xButtonTexture =
                content.Load<Texture2D>(@"Texture\Buttons\XButton");
            yButtonTexture =
