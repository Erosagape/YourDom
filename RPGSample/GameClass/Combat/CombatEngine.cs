    ...
    class CombatEngine
    {
        ...
        private void CreateCombatEffectSprites()
        {
            ...
            damageCombatEffectTexture =
                content.Load<Texture2D>(@"Texture\Combat\DamageIcon");
            healingCombatEffectTexture =
                content.Load<Texture2D>(@"Texture\Combat\HealingIcon");
        }
        ...
        private void CreateSelectionSprites()
        {
            ...
            highlightForegroundSprite.Texture =
                content.Load<Texture2D>(@"Texture\Combat\TilesheetSprangles");
            ...
            highlightBackgroundSprite.Texture =
                content.Load<Texture2D>(@"Texture\Combat\CharSelectionRing");
            ...
            primaryTargetSprite.Texture =
                content.Load<Texture2D>(@"Texture\Combat\Target1SelectionRing");
            ...
            secondaryTargetSprite.Texture =
                content.Load<Texture2D>(@"Texture\Combat\Target2SelectionRing");
        }
